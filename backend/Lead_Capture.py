...
def Lead_Capture(Domain, Name, EmailID, Contact, prefer_Mode_of_Contact, Project_Domain, Project_Description):
    ...
    body = String_formation_for_mail_sending(Domain, Name, EmailID, Contact, prefer_Mode_of_Contact, Project_Domain, Project_Description)
